...
// require("../vendor/twentytwenty/css/twentytwenty.scss");
require("../vendor/twentytwenty/css/twentytwenty-no-compass.scss");
require("../vendor/twentytwenty/js/jquery.event.move");
require("../vendor/twentytwenty/js/jquery.twentytwenty");

($ => {

    let twentyTwentyBundle = {
            init: function() {
    ...
    module.exports = twentyTwentyBundle;
